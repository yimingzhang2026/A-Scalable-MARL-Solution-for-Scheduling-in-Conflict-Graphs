...
def get_config():
    ...
    parser.add_argument("--user_name", type=str, default='ymzhang',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument("--data_chunk_length", type=int, default=64,
